...
export default function ShopClient() {
  ...
  const [allProducts, setAllProducts] = useState([]);   // ✅ จุดที่ 1 เพิ่ม บรรทัด 29
  ...
  const fetchProducts = async () => {
   ...
   // ✅ จุดที่ 2 เพิ่ม function นี้ บรรทัด 67
  ...
  //แก้ตัวจำนวนสินค้าsidebar
    // ✅ จุดที่ 3 เปลี่ยนจาก products → allProducts
  const categoryCounts = useMemo(() => {
    ...
    allProducts.forEach((p) => {
      ...
      const subId = p.subCategoryId?._id;
      if (subId) {
    ...
    return counts;
  }, [allProducts]); // ← dependency เปลี่ยนด้วย
