          ...
          <Card key={review._id} className="p-4 space-y-2 border-gray-200">
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                ...
                <Dialog
                  open={confirmDeleteId === review._id}
      ...
      {reviews.length > REVIEWS_PER_PAGE && (
        <div className="flex justify-center gap-2 pt-4">
          ...
          <span className="text-sm text-muted-foreground flex items-center">
            หน้า {page} / {Math.ceil(reviews.length / REVIEWS_PER_PAGE)}
          </span>
          <Button
            variant="outline"
            size="sm"
            onClick={() => setPage((prev) => Math.min(prev + 1, Math.ceil(reviews.length / REVIEWS_PER_PAGE)))}
